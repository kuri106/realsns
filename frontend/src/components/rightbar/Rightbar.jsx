  ...
  const HomeRightbar = () => {
    ...
    return (
      <>
        ...
        <img src={PUBLIC_FOLDER + "/event.jpeg"} alt=""  className='eventImage'/>
        <h4 className="rightbarTitle">オンラインのお友達</h4>
        ...
        <img src={PUBLIC_FOLDER + "/promotion/promotion1.jpeg"}
          alt = ""
          className='rightbarPromotionImage' />
        <p className="promotionName">ショッピング</p>
        <img src={PUBLIC_FOLDER + "/promotion/promotion2.jpeg" }
          alt = ""
          className='rightbarPromotionImage' />
        <p className="promotionName">カーショップ</p>
        <img src={PUBLIC_FOLDER + "/promotion/promotion3.jpeg" }
          alt = ""
          className='rightbarPromotionImage' />
        <p className="promotionName">Shin Code</p>
      </>
    );
  }
